...
# ax.plot(theta_values, n_theta_0_90[:, 0], "-sk",  label=r"$n_s(0°)$")
ax.plot(theta_values, n_theta_0_90[:, 1], "-or",  label=r"$n_s(90°)$")
...
popt_45, pcov_45 = curve_fit(
                                                   model_45, angle, data["n_s 45°"],
