...
Q_k = [get_Q_k(k, w_0, Gamma, mu, N, beta) for k in k]
# Q_k_Matsubara = [get_Q_k_Matsubara(k, omega, w_0, Gamma, mu, N, beta) for k in k]
sigma_k = [get_sigma_k(k, omega, w_0, Gamma, mu, beta) for k in k]
